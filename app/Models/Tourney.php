...
class Tourney extends Model
{
    ...
    public function queryupdate($request){
        DB::update('UPDATE tournaments SET name = :name, prize = :prize, fk_Venueid_Venue = :venue, fk_Organizerid_Organizer = :org, fk_Time_Controlid_Time_Control = :timecontrol where id_Tournament = :id',
                                                                                                                ['name' => $request->name,
                                                                                                                'prize' => $request->prize,
                                                                                                                'venue' => $request->venue,
